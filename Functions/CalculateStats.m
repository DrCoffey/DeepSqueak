function stats = CalculateStats(I,windowsize,noverlap,nfft,SampleRate,Box,EntropyThreshold,AmplitudeThreshold)
...
iter = iter+1;
if iter > 5; disp('Could not detect contour'); greaterthannoise = [1 1]; break; end
