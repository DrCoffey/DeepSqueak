function  Calls=SqueakDetect(inputfile,networkfile,fname,Settings,include_date,savefile,currentFile,totalFiles)
% Find Squeaks
...
% Remove Low Power Calls
c=0;
for i=1:length(Calls)
if  Calls(i).Power>powerthresh
    c=c+1;
    tmp(c)=Calls(i);
end
end
